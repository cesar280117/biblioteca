...
<body class="hold-transition sidebar-mini layout-fixed">
    <div id="app">
        <div class="wrapper">
            ...
            <aside id="menu" class="main-sidebar elevation-4">
                <!-- Brand Logo -->
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{asset('dist/img/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle"
                        style="opacity: .8">
                    <span class="brand-text text-light">Ues Sistema</span>
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="{{asset('dist/img/usuario_cesar.png')}}" class="img-circle elevation-2" alt="User Image">
                        </div>
                        <div class="info">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="/" class="text-light {{ Request::path() === '/' ? 'nav-link active' : 'nav-link' }}">
                            ...
                            <li class="nav-item">
                                <a  href="{{route('usuarios.index')}}"
                                    class="text-light {{ Request::path() === 'usuarios' ? 'nav-link active' : 'nav-link' }}">
                            ...
                            <li class="nav-item">
                                <a href="/alumnos"
                                    class="text-light {{ Request::path() === 'alumnos' ? 'nav-link active' : 'nav-link' }}">
                            ...
                            <li class="nav-item">
                                <a href="/docentes"
                                    class="text-light {{ Request::path() === 'docentes' ? 'nav-link active' : 'nav-link' }}">
                                    <i class="nav-icon fas fa-male"></i>
                                    <p>
                                        Docentes
                                        <?php use App\Docente; $users_count = Docente::all()->count(); ?>
                                        <span class="right badge badge-danger">{{ $users_count ?? '0' }}</span>
                                    </p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="/carreras"
                                    class="text-light {{ Request::path() === 'carreras' ? 'nav-link active' : 'nav-link' }}">
                                    <i class="nav-icon fas fa-book"></i>
                                    <p>
                                        Carreras
                                        <?php use App\Carrera; $users_count = Carrera::all()->count(); ?>
                                        <span class="right badge badge-danger">{{ $users_count ?? '0' }}</span>
                                    </p>
                                </a>
                            </li>
